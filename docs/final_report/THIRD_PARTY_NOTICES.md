...
| mo-thecreator/vit-Facial-Expression-Recognition | Video model | https://huggingface.co/mo-thecreator/vit-Facial-Expression-Recognition | License uncertain; verify model card | Third-party integrated inference model | Weights not redistributed; local-only | Yes |
